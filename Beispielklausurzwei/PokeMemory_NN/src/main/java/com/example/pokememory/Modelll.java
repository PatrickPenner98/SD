...
public class Modelll{
    public final int ANZAHLZEILEN = 4;
    public final int ANZAHLSPALTEN = 4;
    public final int ANZAHLBILDER = ANZAHLZEILEN * ANZAHLSPALTEN /2;

    private int [][] zahlen = new int [ANZAHLZEILEN][ANZAHLSPALTEN];
    private boolean [][] aufgedeckt = new boolean [ANZAHLZEILEN][ANZAHLSPALTEN];
    private int anzahl_vorlaeufig_aufgedeckt;
    private int [][] vorlaeufig_aufgedeckt = new int [2][2];
